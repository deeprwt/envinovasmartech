...
const story_data:IStory[] = [
  {
    ...
    body_title:`The Story BehindEnvinoa Tech’s Identity`,
    body_desc:[
        `AtEnvinoa Tech, our name itself is a reflection of our core values. "Pi," often associated with the mathematical constant (π), symbolizes precision, intelligence, and a data-driven approach, all critical to the work we do in the field of diagnostics. "Star" represents excellence, leadership, and innovation, underscoring our commitment to pushing the boundaries of healthcare technology.`,
        `Together,Envinoa  encapsulates our mission: to deliver high-precision, innovative solutions that address real-world healthcare challenges. This is embodied in our flagship product, DiaPS Mat, designed specifically for diabetic foot care and biomechanical analysis. It showcases how we integrate cutting-edge technology with advanced biomechanics to offer life-saving diagnostics.`,
      ],
  ...
  },
  {
    ...
    body_desc:[
        ...
        'AtEnvinoa Tech, we offer the DiaPS Mat, a state-of-the-art solution designed for diabetic foot care and biomechanical analysis. This innovative tool empowers users with the ability to detect and manage foot-related complications early, ensuring continuous and proactive care ',
  ...
  },
  {
    ...
    body_desc:[
        'AtEnvinoa Tech, we believe that as human beings, our deepest drive is to thrive—both in health and in the tools we create to ensure it. Our mission is to empower healthcare professionals and patients to not only manage their conditions but to advance and grow with the right technology.',
        ...
        'AtEnvinoa Tech, we are committed to continuous innovation, providing solutions that allow individuals and healthcare systems to thrive for life.'
    ],
    body_subtitle:'FINAL results',
