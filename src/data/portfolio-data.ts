...
const portfolio_data: IPortfolio[] = [
  {
    ...
    img: img_1,
    tags: ["PRINT", "DESIGN"],
    para: "Reduce operational costs and enhance sustainability with smart solar solutions designed for commercial and industrial spaces.",
    title: "Businesses",
  ...
  },
  {
    ...
    tags: ["Mobile", "UI/UX"],
    sub_title: "User Interface",
    para: "Empower public infrastructure with reliable, renewable energy solutions that drive efficiency and sustainability.",
    title: "Government",
    portfolio: "portfolio-v2-page",
  },
  {
    ...
    tags: ["Branding", "UI/UX"],
    sub_title: "User Interface",
    para: "Bring energy access to remote areas with off-grid solar solutions that improve livelihoods and connectivity.",
  ...
  },
  {
    ...
    tags: ["BANNER", "WEB DESIGN"],
    sub_title: "User Interface",
    para: "Support eco-friendly pilgrim sites with sustainable power solutions that enhance visitor experience and reduce carbon footprint.",
  ...
  },
  {
    ...
    tags: ["Mobile", "UI/UX"],
    sub_title: "User Interface",
    para: "Create a lasting social impact with solar-powered initiatives that promote green energy and community development.",
