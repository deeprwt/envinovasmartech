...
import award from "@/assets/pdf/elets.png";
              ...
              <div className="line-wrapper pb-30 mt-60 lg-mt-40 mb-70 lg-mb-40">
                <div className="row align-items-center">
                  <div className="col-md-6 wow fadeInUp">
                    ...
                    <p>
                      We aspire to be the visionary of a future where the
                      seamless integration of unparalleled talent and
                      cutting-edge technology not only redefines success for
                      businesses but sets an entirely new standard for global
                      excellence
                    </p>
                    {/* <CardItem
